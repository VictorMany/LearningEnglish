...
<script>
import CardImgColor from "./CardImgColor.vue";
export default {
  components: { CardImgColor },
  created() {
    this.imagen = "img/colors_grey.jpg";
    this.color = "grey-13";
    this.textoEspaniol = "El gato es gris";
    this.audio = "Grey";
    this.textoIngles = "The cat is GREY";
  },
  data() {
    return {
      numbers_0_20: false,
